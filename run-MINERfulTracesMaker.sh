...
TESTBED_SIZE=1000
MEMORY_MAX="2048m"
OUTPUT_FILE="./temp/WhereTheDonkeyFalls-example.xes"
...
. ./libs.cfg
java -Xmx$MEMORY_MAX -cp MINERful.jar $MAINCLASS -a $alphabet -m $MIN_STRLEN -M $MAX_STRLEN -L $TESTBED_SIZE -oLF $OUTPUT_FILE -oE "xes" -r `Response a b` `Precedence d c`
